  ...
  it: {
    ...
    landing: {
      ...
      preview: {
        ...
        copiesMany: "{{count}} copie disponibili",
        emptyTitle: "Nessun libro disponibile al momento.",
        emptyBody: "Controlla presto oppure pubblica il primo annuncio.",
  ...
  en: {
    ...
    landing: {
      ...
      preview: {
        ...
        copiesMany: "{{count}} copies available",
        emptyTitle: "No books are available at the moment.",
        emptyBody: "Check again soon or create the first listing.",
